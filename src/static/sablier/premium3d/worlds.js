...
export const RECIPES = {
  star_tree: {
    photo: {src: "star_tree.webp", particles: [{kind: "fireflies", box: [[-12, 2], [-1, 6], [-20, -6]]}]},
  ...
  eternity_fountain: {
    photo: {src: "eternity_fountain.webp", particles: [{kind: "marine", color: "#9ff3e8", velocity: [0.04, 0.06, 0], box: [[-8, 4], [-3, 6], [-18, -5]]}]},
  ...
  eden: {
    photo: {src: "eden.webp", particles: [{kind: "dust", color: "#fff2b0", count: 120, box: [[-10, 10], [-2, 8], [-20, -4]]}]},
  ...
  time_river: {
    env: {"panorama": "qwantani_moonrise_puresky", "kind": "night", "zenith": "#070d1d", "horizon": "#314b76", "ground": "#090d18", "light": "#f2d6a0", "glow": "#9dcaff", "elevation": 6, "azimuth": 190, "intensity": 3.8, "size": 3.2, "haze": 0.6, "directIntensity": 1},
    fog: ["#243a5c", 0.0058],
  },
  memories: {
    photo: {src: "memories.webp", particles: [{kind: "dust", color: "#ffd9a0", count: 90, box: [[-9, 0], [-1, 5], [-12, -4]]}]},
  ...
  interstellar: {
    photo: {src: "interstellar.webp", particles: []},
  ...
  galaxy: {
    photo: {src: "galaxy.webp", particles: []},
  ...
  heaven: {
    photo: {src: "heaven.webp", particles: [{kind: "dust", color: "#ffffff", count: 60, opacity: 0.35, box: [[-12, 12], [-2, 8], [-20, -4]]}]},
  ...
  oasis: {
    photo: {src: "oasis.webp", particles: [{kind: "dust", color: "#ffe2a8", count: 60}]},
  ...
  abyss: {
    photo: {src: "abyss.webp", particles: [{kind: "marine"}]},
  ...
  rain_refuge: {
    photo: {src: "rain_refuge.webp", particles: []},
  ...
  aurora_valley: {
    photo: {src: "aurora_valley.webp", particles: []},
  ...
  spring_meadow: {
    photo: {src: "spring_meadow.webp", particles: [{kind: "petals"}]},
  ...
  summer_terrace: {
    photo: {src: "summer_terrace.webp", particles: [{kind: "dust", color: "#fff0c0", count: 80, box: [[-10, 10], [-2, 7], [-18, -4]]}]},
  ...
  autumn_lake: {
    photo: {src: "autumn_lake.webp", particles: [{kind: "leaves"}]},
  ...
  winter_lodge: {
    photo: {src: "winter_lodge.webp", particles: [{kind: "snow"}]},
  ...
  rain_city: {
    photo: {src: "rain_city.webp", particles: [{kind: "rain"}]},
  ...
  ocean_cliffs: {
    photo: {src: "ocean_cliffs.webp", particles: []},
  ...
  sahara_observatory: {
    photo: {src: "sahara_observatory.webp", particles: [{kind: "sand"}]},
  ...
  ancient_forest: {
    ...
    photo: {src: "ancient_forest.webp", particles: [{kind: "dust"}]},
  ...
  storm_cliffs: {
    photo: {src: "storm_cliffs.webp", lightning: true, particles: [{kind: "rain", opacity: 0.22, velocity: [2.5, -10, 0]}]},
  ...
  ember_hearth: {
    photo: {src: "ember_hearth.webp", particles: [{kind: "sparks"}]},
  ...
  polar_sky: {
    photo: {src: "polar_sky.webp", particles: []},
  ...
  midnight_rooftop: {
    photo: {src: "midnight_rooftop.webp", particles: []},
