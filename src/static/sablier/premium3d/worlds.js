...
export const RECIPES = {
  ...
  star_tree: {
    ...
    water: { level: 0.4, color: "#08202c", roughness: 0.05 },
  ...
  eternity_fountain: {
    ...
    water: { level: 1.2, color: "#166b76", roughness: 0.04 },
  ...
  eden: {
    ...
    water: { level: 0.6, color: "#20524a", roughness: 0.06 },
  ...
  time_river: {
    ...
    water: { level: 0.8, color: "#26375c", roughness: 0.05 },
  ...
  summer_terrace: {
    ...
    fog: ["#d8bf94", 0.0028],
    ground: { profile: "hills", color: "#9a7c50", material: "sand", height: 0.85, offset: 60 },
    water: { level: -1.2, color: "#2f6f78", roughness: 0.05, size: 700, offset: 260 },
    grove: { kind: "olive", count: 40, near: 70, far: 300, height: [8, 16] },
    props: [{ kind: "pergola", color: "#8c7a5f", vine: "#43663c", width: 46, depth: -34, height: 15 }],
  ...
  ancient_forest: {
    env: { kind: "day", turbidity: 6, rayleigh: 2.4, mie: 0.008, mieG: 0.84, elevation: 34, azimuth: 42, light: "#dff2bf", directIntensity: 3.6, exposure: 0.5, ambient: 2.1 },
    fog: ["#31564a", 0.0034],
    ground: { profile: "plain", color: "#3d5a42", material: "rock", height: 0.7, grain: 70 },
