...
export function makeGlass(THREE){return new THREE.MeshPhysicalMaterial({color:0xf4fbff,roughness:0.025,metalness:0,transmission:0.96,thickness:0.72,ior:1.46,transparent:true,opacity:1,clearcoat:1,clearcoatRoughness:0.015,side:THREE.DoubleSide,depthWrite:false});}
