...
- Name: reliability.spec.cjs >> reprise après fermeture et échéance pendant l’absence
- Location: tests\browser\reliability.spec.cjs:54:1
...
Call log:
  - waiting for locator('#main-control')
    - locator resolved to <button class="primary" id="main-control">▶ DÉMARRER</button>
        ...
        - generic [ref=f2e41]:
          - complementary [ref=f2e42]:
            ...
            - generic [ref=f2e48]:
              ...
              - button "OK" [active] [ref=f2e50] [cursor=pointer]
            - generic [ref=f2e51]:
            ...
            - generic [ref=f2e96]:
              ...
              - combobox "COMPÉTENCE TRAVAILLÉE" [ref=f2e97]:
                - option "Aucune · ne rien reporter"
                - option "Période de recette · Déjà maîtrisée" [selected]
          ...
          - generic [ref=f2e102]:
            - generic [ref=f2e103]:
              - generic [ref=f2e104]: ● PRÊT
              - generic [ref=f2e105]: ARBRE DES ÉTOILES · FOCUS 2
            - paragraph [ref=f2e106]: REPRISE MOBILE
            - generic [ref=f2e108]:
              - strong [ref=f2e109]: 00:02
              - text: COMPTE À REBOURS
            - status
        - generic [ref=f2e111]:
          - button "− 1 min" [ref=f2e112] [cursor=pointer]
          - button "▶ DÉMARRER" [ref=f2e113] [cursor=pointer]
          - button "↻ Réinitialiser" [ref=f2e114] [cursor=pointer]
          - button "+ 1 min" [ref=f2e115] [cursor=pointer]
        - generic [ref=f2e116]:
          - generic [ref=f2e117]:
            - paragraph [ref=f2e118]: PLAYLIST PERSONNELLE
            - strong [ref=f2e119]: Aucune playlist pour l’instant
          - paragraph [ref=f2e120]: Ajoutez vos musiques, puis réunissez-les en playlist pour accompagner vos sessions.
          - link "Ajouter des musiques" [ref=f2e121] [cursor=pointer]:
            - /url: /sablier/audio/
          - link "Créer une playlist" [ref=f2e122] [cursor=pointer]:
